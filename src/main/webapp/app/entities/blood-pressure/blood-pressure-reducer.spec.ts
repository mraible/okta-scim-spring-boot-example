...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOODPRESSURE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BLOODPRESSURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BLOODPRESSURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BLOODPRESSURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BLOODPRESSURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BLOODPRESSURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BLOODPRESSURE actions', async () => {
      const expectedActions = [
        {
