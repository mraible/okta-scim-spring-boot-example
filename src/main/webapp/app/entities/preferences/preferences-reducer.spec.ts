...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREFERENCES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREFERENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREFERENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREFERENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREFERENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREFERENCES actions', async () => {
      const expectedActions = [
        {
